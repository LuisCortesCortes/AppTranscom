...
export class CargarDocumentoInstruccionesScreen extends Component {
    ...
    buttonPressedCargarDocumento() {
        const token = this.props.route.params.token;
        this.props.navigation.navigate('CargarDocumentoScan', {token})
    }
    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.nombre} >Cargar Documento</Text>
                ...
                <View style={styles.buttonStyle}>
                    <TouchableOpacity
                        ...
                        <Text style={styles.TextStyle}> Capturar Código </Text>
                    </TouchableOpacity>
                </View>

                <Text style={[{alignSelf: 'center'},{marginTop: '5%'}]}>Por favor, siga las instrucciones antes de continuar</Text>

                <Text style={[{alignSelf: 'flex-start'},{marginTop: '5%'},{marginLeft: '5%'}]}>1. Para comenzar, presione el boton "Capturar Código"</Text>
                <Text style={[{alignSelf: 'flex-start'},{marginTop: '2%'},{marginLeft: '5%'}]}>2. Gire su teléfono de manera Horizontal</Text>
                <Text style={[{alignSelf: 'flex-start'},{marginTop: '2%'},{marginLeft: '5%'}]}>3. Enfoque el código con luz clara</Text>
                <Text style={[{alignSelf: 'flex-start'},{marginTop: '2%'},{marginLeft: '5%'}]}>4. Espero a que el teléfono Vibre para confirmar el documento escaneado</Text>

                <Image
                    style={styles.rotate}
                    source={require('../assets/images/rotate.gif')}
                />
